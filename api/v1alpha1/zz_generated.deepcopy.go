...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TestRunHook) DeepCopyInto(out *TestRunHook) {
	*out = *in
	in.Helm.DeepCopyInto(&out.Helm)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TestRunHook.
func (in *TestRunHook) DeepCopy() *TestRunHook {
	if in == nil {
		return nil
	}
	out := new(TestRunHook)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UnstructuredData.
